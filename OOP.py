...
# Adding Students
student1 = Student(punjab_university, 101, "Saad", "Ali")
student2 = Student(punjab_university, 102, "Babar", "Fahad")
student3 = Student(punjab_university, 103, "Shahid", "Junaid")
...
teacher2 = Teacher("Prof. Johnson", "Computer Science", {
    "Tuesday": "11 AM - 1 PM",
    "Thursday": "1 PM - 3 PM"
})
